...
template<> struct device::Filter<device::GPU>
{
    struct Requirements
    {
        ...
        struct Limit
        {
            ...
            static constexpr Value equals(device::GPU::Properties::Limits::Sample_count v_a)
            {
                static_assert(sizeof(Value::data) >= sizeof(v_a));
        ...
        using Kind = GPU::Properties::Kind;
        using Feature = GPU::Properties::Feature;
...
template<> struct device::Filter<device::Display>
{
    struct Requirements
    {
        device::Display::Properties::Kind kind;
